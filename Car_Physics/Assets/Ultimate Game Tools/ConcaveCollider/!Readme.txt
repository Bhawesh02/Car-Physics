________________________________________________________________________________________
                                    Concave Collider
                        Copyright © 2012-2024 Ultimate Game Tools
...
Unity 2020.3.7f1 or above for Windows or Mac
...
[FIX] Upgraded to Unity 2020.3.x for Windows

v1.26 - 25/11/2019

[FIX] Re-saved all scenes and fixed 2019 compatibility issues. Removed console error:
      EndLayoutGroup: BeginLayoutGroup must be called first.

v1.25 - 12/04/2017

[FIX] Changed default settings for the legacy algorithm so that it doesn't create boxes
	  anymore.
